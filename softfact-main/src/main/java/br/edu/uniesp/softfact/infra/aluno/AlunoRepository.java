...
public interface AlunoRepository extends JpaRepository<AlunoEntity, Long> {
    ...
    @Query("SELECT a FROM AlunoEntity a WHERE " +
           ...
           "LOWER(a.matricula) LIKE LOWER(CONCAT('%', :termo, '%'))")
    Page<AlunoEntity> buscarPorTermo(@Param("termo") String termo, Pageable pageable);
...
//    public record AlunoListaDTO(Long id, String nome, String email, String periodo, int qtdCertificados) {}
//
//    @Query("""
